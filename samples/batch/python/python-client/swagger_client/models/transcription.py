...
class Transcription(object):
    ...
    def __init__(self, recordings_url=None, id=None, models=None, locale=None, results_urls=None, status_message=None, created_date_time=None, last_action_date_time=None, status=None, name=None, description=None, properties=None):  # noqa: E501
